    ...
    <div className="grid md:grid-cols-3 gap-5">
      {allProjects.map((p) => (
        <a
          ...
          data-reveal
          className="group relative overflow-hidden border border-ink-3 bg-ink-2/60 p-7 min-h-64 flex flex-col justify-between transition-colors hover:border-paper-faint"
          style={{
            backgroundImage:
        ...
        >
          ...
          <p className="mt-6 font-mono text-[0.65rem] tracking-wide text-paper-faint">
            {p.tech.join(" · ")}
          </p>
        </a>
      ))}
